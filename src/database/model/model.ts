...
export const RESPONDENT_ROLE_SPECIFY_OPTION = "Specify" as const;

export const DEFAULT_RESPONDENT_INFORMATION_FIELDS: RespondentInformationField[] =
  ["fullName", "email", "role"];

export const DEFAULT_RESPONDENT_ROLE_OPTIONS: RespondentRoleOption[] = [
  "Student",
  "Faculty",
  "QA Personnel",
  "Administrator",
  RESPONDENT_ROLE_SPECIFY_OPTION,
];
...
export type SurveyForm = {
  ...
  documentHeader?:
    | typeof QUESTIONNAIRE_DOCUMENT_HEADER
        ...
        items: [
          {
            ...
            statement:
              "I collect available documents from different offices manually.",
            sortOrder: 1,
          },
          {
            code: "existing_collection_02",
            statement:
              "I observe a lack of standardized document formatting, which leads to duplication.",
            sortOrder: 2,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I find physical documents too heavy or bulky after the accreditation process.",
            sortOrder: 6,
          },
          {
            code: "existing_collection_07",
            statement:
              "I observe that physical documents are susceptible to loss or damage.",
            sortOrder: 7,
          },
          {
            code: "existing_collection_08",
            statement:
              "I experience a lack of digital access and control over collected documents.",
            sortOrder: 8,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I observe that the manual filing system often results in disorganized documents.",
            sortOrder: 1,
          },
          {
            code: "existing_organization_02",
            statement:
              "I experience the absence of a centralized digital management system for documents.",
            sortOrder: 2,
          },
          {
            code: "existing_organization_03",
            statement:
              "I observe a lack of standardized templates for organizing documents.",
            sortOrder: 3,
          },
          {
        ...
        items: [
          {
            ...
            statement:
              "I find the submission of physical documents too heavy and burdensome.",
            sortOrder: 1,
          },
          {
            code: "existing_submission_02",
            statement:
              "I observe that submitted documents often contain incomplete or missing data.",
            sortOrder: 2,
          },
          {
            code: "existing_submission_03",
            statement:
              "I experience rushed submission due to the lack of a digital system.",
            sortOrder: 3,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I observe that the local task force lacks sufficient knowledge in Google Form submission.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I observe a high possibility of human error in the validation process.",
            sortOrder: 1,
          },
          {
            code: "existing_validation_02",
            statement:
              "I find validation too bulky or burdensome for validators or accreditors.",
            sortOrder: 2,
          },
          {
            code: "existing_validation_03",
            statement:
              "I observe that documents being validated are often unclear or difficult to review.",
            sortOrder: 3,
          },
          {
            code: "existing_validation_04",
            statement:
              "I observe that documents are often missing, or the links provided are unresponsive.",
            sortOrder: 4,
          },
          {
            code: "existing_validation_05",
            statement:
              "I observe that comments from accreditors are not properly addressed.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I can get search results quickly for common queries such as program, area, and parameter.",
            sortOrder: 1,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I can efficiently narrow results by filtering through program, area, and parameter.",
            sortOrder: 3,
          },
          {
            code: "system_performance_04",
            statement:
              "I can use the system smoothly even during peak periods such as near survey visits.",
            sortOrder: 4,
          },
          {
            code: "system_performance_05",
            statement:
              "I am satisfied with the system's speed and responsiveness.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I find that the area-to-parameter mapping fits AACCUP's structure.",
            sortOrder: 1,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I can clearly see who made changes, what was changed, and when it was changed through the audit trail.",
            sortOrder: 3,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I find that the system's features are focused and free from unnecessary redundancy.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I find that the system functions as expected with minimal errors.",
            sortOrder: 1,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I experience consistent and accurate synchronization between web and mobile devices.",
            sortOrder: 3,
          },
          {
            code: "system_reliability_04",
            statement:
              "I rarely encounter crashes, timeouts, or unexplained errors while using the system.",
            sortOrder: 4,
          },
          {
            code: "system_reliability_05",
            statement:
              "I am confident in the system's reliability for daily use.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I find that the metadata rules properly enforce correct program, area, and parameter tagging.",
            sortOrder: 1,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I find that the system consistently adheres to required standards and policies.",
            sortOrder: 4,
          },
          {
            code: "system_conformance_05",
            statement:
              "I believe that the repository conforms to AACCUP and institutional policies.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I find that the system remains stable under heavy loads involving many users and files.",
            sortOrder: 1,
          },
          {
            code: "system_durability_02",
            statement:
              "I trust that backups and restore procedures protect the long-term integrity of evidence.",
            sortOrder: 2,
          },
          {
            code: "system_durability_03",
            statement:
              "I can continue to access evidence over time without any issues.",
            sortOrder: 3,
          },
          {
            code: "system_durability_04",
            statement:
              "I find that updates and fixes do not disrupt existing workflows.",
            sortOrder: 4,
          },
          {
            code: "system_durability_05",
            statement:
              "I can continue using the system without needing reinstallation or system wipes.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I can easily find and follow the help guides and training materials.",
            sortOrder: 1,
          },
          {
            code: "system_serviceability_02",
            statement:
              "I find that error messages are clear and helpful in resolving issues.",
            sortOrder: 2,
          },
          {
            code: "system_serviceability_03",
            statement:
              "I find that support requests are handled promptly and effectively.",
            sortOrder: 3,
          },
          {
            code: "system_serviceability_04",
            statement:
              "I receive fixes or assistance within a reasonable timeframe after reporting a problem.",
            sortOrder: 4,
          },
          {
            code: "system_serviceability_05",
            statement:
              "I find that updates for web and mobile arrive automatically without disruption.",
            sortOrder: 5,
          },
          {
            code: "system_serviceability_06",
            statement:
              "I would use the support or service channels again in the future.",
            sortOrder: 6,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            statement:
              "I find that the labels and icons are consistent and easy to understand.",
            sortOrder: 2,
          },
          {
            code: "system_aesthetics_03",
            statement:
              "I find that the page layouts make tasks such as upload and review straightforward.",
            sortOrder: 3,
          },
          {
            code: "system_aesthetics_04",
            statement:
              "I find that the color, contrast, and readability support long work sessions.",
            sortOrder: 4,
          },
          {
            code: "system_aesthetics_05",
            statement:
              "I find that the visual design helps me stay focused and does not distract from the work.",
            sortOrder: 5,
          },
          {
            code: "system_aesthetics_06",
            statement:
              "I find that the overall design is professional and appropriate for accreditation.",
            sortOrder: 6,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I trust this system to support AACCUP accreditation activities.",
            sortOrder: 1,
          },
          {
          ...
          },
          {
            ...
            statement:
              "I would recommend this repository to colleagues involved in accreditation.",
            sortOrder: 3,
          },
          {
            code: "system_perceived_quality_04",
            statement:
              "I find that the system's overall quality meets or exceeds my expectations.",
            sortOrder: 4,
          },
          {
            code: "system_perceived_quality_05",
            statement:
              "I am confident relying on this system during actual survey visits.",
            sortOrder: 5,
          },
        ],
      },
        ...
        items: [
          {
            ...
            statement:
              "I can access the survey page without difficulty using the provided link.",
            sortOrder: 1,
          },
          {
            code: "respondent_accessibility_02",
            statement:
              "I can understand the survey instructions before answering the checklist.",
            sortOrder: 2,
          },
          {
            code: "respondent_accessibility_03",
            statement:
              "I can move through the respondent information and checklist steps easily.",
            sortOrder: 3,
          },
          {
        ...
        items: [
          {
            ...
            statement:
              "I can clearly identify which checklist items still need to be answered before submission.",
            sortOrder: 1,
          },
          {
            code: "respondent_submission_02",
            statement:
              "I can submit my response without confusion or unnecessary steps.",
            sortOrder: 2,
          },
          {
            code: "respondent_submission_03",
            statement:
              "I receive clear feedback when my survey response is submitted successfully.",
            sortOrder: 3,
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            statement:
              "I feel confident that my response will be used only for academic and research purposes.",
            sortOrder: 2,
          },
          {
            code: "respondent_privacy_03",
            statement:
              "I am comfortable answering the survey using this online system.",
            sortOrder: 3,
          },
        ],
      },
...
export function getLikertInterpretation(mean: number) {
  return (
    LIKERT_SCALE.find(
      (scale) => mean >= scale.minMean && mean <= scale.maxMean,
    ) ?? LIKERT_SCALE[LIKERT_SCALE.length - 1]
  );
}